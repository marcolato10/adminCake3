...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'users_ibfk_1' => ['type' => 'foreign', 'columns' => ['documento_id'], 'references' => ['documentos', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'active' => 1,
                'created' => '2021-04-15 21:54:20',
                'modified' => '2021-04-15 21:54:20',
                'documento_id' => 1,
            ],
        ];
        parent::init();
