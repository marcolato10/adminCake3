...
class DocumentosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'documento' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2021-04-21 16:27:10',
                'modified' => '2021-04-21 16:27:10',
            ],
        ];
        parent::init();
    }
